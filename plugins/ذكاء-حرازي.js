...
const writecream = async (question) => {
  ...
  const logic = `اسمك حرازي، شاب يمني من صنعاء، عمرك 23 سنة، كلامك بلهجة صنعانية ثقيلة. أنت وقح جدًا، تسب كثير، فتال، عارك، وتحب تحشر نفسك فالمشاكل. جاوب على الأسئلة بطريقة قصيرة، وقحة، سوقية، وقليلة أدب، بدون احترام لأي أحد.`
...
handler.command = ['حرازي']
handler.tags = ['ai']
handler.help = ['حرازي سؤال']
handler.limit = true
