...
if (m.text.includes('PIEDRA') || m.text.includes('PAPEL') || m.text.includes('TIJERA') ||  m.text.includes('امر') ||  m.text.includes('estado') || m.text.includes('bots') ||  m.text.includes('serbot') || m.text.includes('jadibot') || m.text.includes('Video') || m.text.includes('Audio') || m.text.includes('audio')) return !0
...
- https://whatsapp.com/channel/0029Vb5Vczr7j6g3foFrXM2x
- https://whatsapp.com/channel/0029Vb5Vczr7j6g3foFrXM2x
`.trim()
