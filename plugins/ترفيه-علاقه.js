...
*╰•·–––––––––––––––––––·•*`;
    ...
    await conn.sendMessage(m.chat, {
        text: caption,
        footer: `💟 عنده شريك ⇢ ${pareja ? `*${user} 💞 ${conn.getName(pareja)}*` : `❌ *معندهوش شريك*`}\n${wm}`,
        buttons: [
            { buttonId: '.الاوامر', buttonText: { displayText: 'الاوامر ☘️' }, type: 1 }
        ],
        headerType: 1
    }, { quoted: m, mentions: await conn.parseMention(caption) });
};
