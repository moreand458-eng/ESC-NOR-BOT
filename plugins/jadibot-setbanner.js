...
const handler = async (m, { text, usedPrefix, command }) => {
  ...
  if (!match) {
    return m.reply(`> 📸 Usa así:\n*${usedPrefix + command} https://qu.ax/dibUg.jpg*, osea sube la imagen a un hosting de imágenes como catbox.moe, o simplemente utiliza .catbox respondiendo a la imagen q quieres de banner.`)
  }
