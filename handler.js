...
global.dfail = (type, m, conn, usedPrefix) => {
    const mensajes = {
        rowner: '「🔥」الامـࢪ دا بـتـا؏ إسِــــکْأّنِـوٌر  مـطـوࢪي.',
  owner:  '「💥」 الامـࢪ دا بـتـا؏ إسِــــکْأّنِـوٌر مـطـوࢪي.',
  premium: '「🔥」 لامـࢪ دا بـتـا؏ الـمـسـتـخـدمـيـن بـس يـسـطـا.',
  private: '「💥」 الامـر دا فـي الـبـف (الـخـاص)  بـس يـسـطـا.',
  admin: '「🔥」 الامـࢪ دا بـتـا؏ الادمــن بــس يــسـطــا.',
  botAdmin: '「💥」 ارفـعـنـي  مـشـࢪف  يـسـطـا وبـعـديـن  نـفـز الامـࢪ.',
  unreg: '「🔥」 سـجـل الاول يـسـطـا لـتـسـجـيـل اڪـتـب.تسجيل الاسم.العمر  مثال/.تسجيل إسكانور.18       لازم عشان تستعمل الامࢪ لازم تسجل',
  restrict: '「💥」 الامـࢪ دا بـودي مـطـوࢪي مـوقـفـو.'
    }
